...
var SurveyWidget = function() {
    function t(e) {
        var a = this;
        _classCallCheck(this, t), this.id = e.id, this.maxTestimonialCharacters = e.maxTestimonialCharacters, this.stars = e.stars, this.callback = e.callback, this.selectors = e.selectors, this.template = e.template, this.loadData().done(function(t) {
            0 === t.length ? $("#testimonial-widget").hide() : ($("#" + a.id + " .slider__content").html(a.template), a.populateData(a.selectors, t, a.maxTestimonialCharacters), $("#".concat(a.id, " .").concat(a.selectors.loading)).remove(), $("#".concat(a.id, " #").concat(a.selectors.surveyTemplateId)).remove()), e.callback && e.callback.call()
        })
    }
